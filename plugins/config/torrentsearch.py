...
url = 'http://api.acestream.me/all?api_version=1.0&api_key=test_api_key'

# Made yourself:
# https://forumtv.site/threads/chto-sluchilos-s-pomojkoj-http-pomoyka-win-trash-ttv-list-sajt-ne-rabotaet.552/
# https://forumtv.site/threads/skript-formirovanija-plejlistov-dlja-acestream-dvizhka.106/
# api: https://api.acestream.me/all?api_version=1.0&api_key=test_api_key
